package com.servermanager10.implementation;
...
import com.servermanager10.service.ServerService;
...
public class ServerServiceImpl implements ServerService {
    ...
    private String setServerImageUrl(){
        String[] imageNames= {"server1.jpg","server2.jpg","server3.png","server4.png"};
